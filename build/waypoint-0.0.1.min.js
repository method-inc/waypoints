...
JSON.stringify(a)),this;localStorage.removeItem("Waypoint.target");return this},ignore:function(a){if(0===arguments.length)return this._ignore;this._ignore=a;return this},route:function(a){if(0===arguments.length)return d.location.href;d.location=a;return this},redirect:function(){var a=this.latest();a&&this.route(a);return this},back:function(){var a=this.history();1<a.length&&(a.pop(),this.history(a),this.redirect());return this},navigate:function(a){this.target(a);this.route(a);return this},latest:function(){var a=
this.history();return a.length?a[a.length-1]:e},intercept:function(a){var b=this;c(f).on("click",a,function(a){return b._onClick(a.target)});return this},_onClick:function(a){if(c(a).is(this._ignore))return!0;a=c(a).attr("href");var b=f.createElement("a");b.href=a;this.navigate(b.href);return!1}};d.Waypoint=new g})(window.jQuery||window.Zepto,window,document);
