(function(c,e,g,f){function h(){this._ignore=f;this._debug=!1}h.prototype={resume:function(a){this.history();var b=this.target(),c=this.latest(),d=this.route();if(b){this.target(f);if(b!==d)return this._debug&&console.log("Waypoint.resume(): bad link -- target ("+b+") does not match route ("+d+"), redirecting..."),this.redirect(),this;this._debug&&console.log("Waypoint.resume(): good link -- arrived at target("+b+"), bookmarking...");this.bookmark()}else if(c&&d!==c)return this._debug&&console.log("Waypoint.resume(): bad route -- route("+
d+") does not match latest ("+c+"), redirecting..."),this.redirect(),this;this._debug&&console.log("Waypoint.resume(): good route -- arrived at route("+d+"), triggering callback...");a&&a();return this},debug:function(a){if(0===arguments.length)return this._debug;this._debug=a;return this},clear:function(){localStorage.removeItem("Waypoint.history");localStorage.removeItem("Waypoint.target");return this},bookmark:function(){var a=this.route();this._debug&&console.log("Waypoint.bookmark(): bookmarking",
